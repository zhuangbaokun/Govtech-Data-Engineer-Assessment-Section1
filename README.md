...
6) Lastly, after extracting the file from github and applying all the sub-functions, we will proceed to export the file into csv with the suffix "\_update\_(date of update)". The suffix helps to inform users of how updated the file is based on the date appended to the file name.
